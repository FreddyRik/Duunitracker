...
export function BackupReminderBanner({
  ...
  return (
    <div
      role="status"
      className="mb-6 flex flex-col gap-3 rounded-2xl border border-accent/30 bg-accent-soft px-4 py-3 sm:flex-row sm:items-center sm:justify-between"
    >
      ...
      <div className="flex shrink-0 flex-wrap items-center gap-2">
        <button
          type="button"
          onClick={onExport}
          className="rounded-lg bg-accent px-3 py-1.5 text-xs font-semibold text-accent-fg transition hover:bg-accent-hover"
        >
          {t.backup.export}
        </button>
        <button
